<div class="body">
    <div class="header">
        ...
        <div class="description">El mapa provee información pronosticada del riesgo agroclimático para el cultivo de maíz que podría presentarse en los próximos meses. La información presentada en el mapa proviene de la red de observación meteorológica del SENAMHI.</div>
        <div class="file"></div>
    </div>
    <hr>
    <div class="content">
