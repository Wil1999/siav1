<div class="body">
    <div class="header">
        ...
        <div class="description">El mapa de índice de humedad provee información que involucra la relación entre la precipitación y la evapotranspiración a nivel nacional. El cálculo del índice tiene un horizonte decadal (del 21 al 30) y utiliza datos meteorológicos de la red de observación meteorológica del SENAMHI.</div>
        <div class="file"></div>
    </div>
    <hr>
    <div class="content">
