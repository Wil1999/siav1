...
<head>
    ...
    <title>SISTEMA DE INFORMACIÓN AGROMETEOROLÓGICA | SIA2</title>
            ...
            <ul>
                ...
                <li>
                    <a href="?p=evapotranspiracion-1ra">
                        <span class="subtitle">Evapotranspiracion </span>
                    </a>

                </li>
                <li>
                    <a href="?p=indice-humedad-1ra">
                        <span class="subtitle">Indice de Humedad </span>
                    </a>
                ...
                <li>
                    <a href="">
                        ...
                        <span class="title">Pronostico </span>
                    </a>
                </li>
                <li>
...
<div class="dataini active" id="inicio">
    ...
    <p class="parrafo"> Este módulo provee información de probabilidad de impactos ocurrencia de lluvias, pronóstico de riesgo agroclimático de los principales cultivos a nivel nacional para los próximos 3 meses.
    </p>
     </div>
    ...
    <p class="parrafo"> Este módulo muestra los Estudios, Atlas, Articulos Cientificos Agrometeorológicos que el Servicio Nacional de Meteorológia e Hidrológia a elaborado.
    </p>
