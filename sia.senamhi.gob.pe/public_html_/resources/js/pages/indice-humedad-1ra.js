...
function createMap() {
    ...
    function load_monitoreos(filter) {
        ...
        sourceReser = new My_Source('https://idesep.senamhi.gob.pe/geoserver/g_04_07/wms?', {
            id: '04_07_001_03_001_531_0000_00_00',
            cql_filter: filter,
    ...
    sourceReser.getLayer('04_07_001_03_001_531_0000_00_00').addTo(mymap);
...
function getDetailsProduct() {
    ...
    //if (product_grupoNomCorto == null || product_grupoNomCorto=="") { product_grupoNomCorto = "Indice de Humedad"; } 
    if (product_grupoNomCorto == null || product_grupoNomCorto=="") { product_grupoNomCorto = "Índice de Humedad (AGO)"; } 
