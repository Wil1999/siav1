...
function createMap() {
    ...
    sourceReser.getLayer('03_02_001_03_000_512_0000_00_00').addTo(mymap);
...
function getDetailsProduct() {
    ...
    $('.panelControl_details .body .header .title').html(`Probabilidad de Ocurrencia de Lluvias Trimestral - ${product_objetoNombreCorto}`);
    $('.toggle2 .titulo1').html(`Probabilidad de Ocurrencia de Lluvias Trimestral `);
