...
function createMap() {
    ...
    //createPane("departamento");
    //mymap.createPane("provincia");
    //mymap.createPane("distrito");

    sourceReser.getLayer('04_06_003_03_001_531_0000_00_00').addTo(mymap);
...
function getDetailsProduct() {
   ...
   // $('.body .header .title').html(`Evapotranspiración de referencia - ${product_grupoNomCorto} `);
   if (product_grupoNomCorto == null || product_grupoNomCorto=="") { product_grupoNomCorto = "Evapotranspiración Potencial (ETO)"; } 
