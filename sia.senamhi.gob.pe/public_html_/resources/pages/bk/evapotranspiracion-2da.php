<a href="?p=evapotranspiracion-1ra" class="tab_menu ">1era Decada</a>
<a href="?p=evapotranspiracion-2da" class="tab_menu active">2da Decada</a>
<a href="?p=evapotranspiracion-3ra" class="tab_menu ">3era Decada</a>


<div class="body"><br>
    <div class="header">
    <div class="descripcion"><p  id="txtcopiar">El mapa de evapotranspiración de referencia no considera las características del cultivo, ni factores del suelo. Su cálculo tiene un horizonte decadal (cada diez días) y utiliza datos meteorológicos de radiación, temperatura del aire, humedad atmosférica y velocidad del viento.
...
<nav class="nav">
        <ul class="list">
            ...
            <li class="list__item list__item--click fila1">
                ...
                <ul class="list__show">
                    <li class="list__inside">
                        <a href="#" class="nav__link nav__link--inside"> <?php Component::view('table-rango-evapotranspiracion') ?></a>
                    </li>
                </ul>
            ...
            <li class="list__item list__item--click">
                <div class="list__button list__button--click">
                <span class="list__img"><i class="fa fa-check" aria-hidden="true"></i></span>
                    <a href="#" class="nav__link">Departamentos por Rangos afectados</a>
                    <span class="list__arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                </div>
            ...
            <li class="list__item list__item--click">
                <div class="list__button list__button--click">
                <span class="list__img"><i class="fa fa-check" aria-hidden="true"></i></span>
                    <a href="#" class="nav__link">Ampliar Rango de Consulta (mm)</a>
                    <span class="list__arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                </div>
               
                <ul class="list__show">
                    <li class="list__inside">
                        <a href="#" class="nav__link nav__link--inside"> <?php  Component::view('filter-rango-evapotranspiracion') ?> </a>
