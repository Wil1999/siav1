...
<a href="?p=riesgo-cafe" class="tab_menu2 active">Café</a>
...
<div class="body"><br>
    <div class="header">
    <div class="descripcion"><p  id="txtcopiar">El mapa provee información del pronóstico  de riesgo agroclimático para el cultivo de <b>CAFE</b> para los proximos 3 meses.  
    ...
    <button id="copyButton" style="background: none;  border: none; cursor: pointer;">   <img src="public/assets/img/copiar.png" alt="Copiar"  width="15" height="15" /></button> |
     <a href="https://www.gob.pe/institucion/senamhi/colecciones/1171-riesgo-agroclimatico-cultivo-de-cafe" target="_blank"><img src="public/assets/img/External.png"  width="15" height="15" /></a>
</p>
    </div>
    </div>
</div>
