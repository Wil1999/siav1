<a href="?p=riesgo-arroz" class="tab_menu2 active">Arroz</a>
...
<div class="body"><br>
    <div class="header">
        <div class="descripcion"><p id="txtcopiar">El mapa provee información del pronóstico  de riesgo agroclimático para el cultivo de <b>ARROZ</b> para los proximos 3 meses. 
       ...
       <a href="https://www.gob.pe/institucion/senamhi/colecciones/1170-riesgo-agroclimatico-cultivo-de-arroz" target="_blank"> <img src="public/assets/img/External.png" alt="Enlace a web Senamhi"  width="15" height="15" /></a>
    </p>
...
<nav class="nav">
        <ul class="list">
            ...
            <li class="list__item list__item--click">
                <div class="list__button list__button--click">
                <span class="list__img"><i class="fa fa-check" aria-hidden="true"></i></span>
                    <a href="#" class="nav__link">Departamentos afectados por nivel de riesgo agroclimático </a>
                    <span class="list__arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                </div>
