...
<div class="body"><br>
    <div class="header">
    <div class="descripcion"><p id="txtcopiar">El mapa provee información del pronóstico  de riesgo agroclimático para el cultivo de <b>PASTO</b> para el mes actual.  
